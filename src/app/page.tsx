  ...
  return (
    <>
      <main className="pb-16 lg:pb-24 bg-white dark:bg-gray-900">
        <header className="bg-[url('https://source.unsplash.com/random/?code,IT,software,developer,javascript,technology')] w-full h-[29rem] xl:h-[33rem] bg-no-repeat bg-cover bg-[50%] bg-blend-darken relative">
